...
import com.msilimon.cropper.CroppingManager
...
internal object CroppingUtils {
    ...
    fun detectTouchedSide(
        ...
        val expandedStrokeWidth = strokeWidth * 40  // Triple the stroke width
    ...
    fun resizeShapeWhenDrag(
        ...
        when (touchedSide) {
            ...
            TouchedSide.RIGHT -> {
                ...
                if (square && newWidth > croppingShapeStrokeWidth &&
                    croppingShapePosition.x + newWidth <= maxX &&
                    newCroppingRectPositionY + newWidth <= maxY
                ) {
                    return Pair(
                        Size(newWidth, newWidth),
            ...
            TouchedSide.TOP -> {
                ...
                if (square && newHeight > croppingShapeStrokeWidth &&
                    newCroppingRectPositionY >= 0 &&
                    newCroppingRectPositionY + newHeight <= maxY &&
                    newCroppingRectPositionX + newHeight <= maxX
                ) {
                    return Pair(
                        Size(newHeight, newHeight),
                        Offset(croppingShapePosition.x, newCroppingRectPositionY)
                    )
                } else if (!square && newHeight > croppingShapeStrokeWidth &&
                    newCroppingRectPositionY >= 0 &&
                    newCroppingRectPositionY + newHeight <= maxY
                ) {
                    return Pair(
            ...
            TouchedSide.BOTTOM -> {
                ...
                if (square && newHeight > croppingShapeStrokeWidth &&
                    croppingShapePosition.y + newHeight <= maxY &&
                    newCroppingRectPositionX + newHeight <= maxX
                ) {
                    return Pair(
                        Size(newHeight, newHeight),
                ...
                } else if (!square && newHeight > croppingShapeStrokeWidth && croppingShapePosition.y + newHeight <= maxY) {
